class OrderAddress
  ...
  attr_accessor :postal_code, :city_id, :municipalities, :address, :building, :tel, :price, :user_id
  ...
  def save
    ...
    Address.create(postal_code: postal_code, city_id: city_id, municipalities: municipalities, address: address, building: building, tel: tel, donation_id: donation.id)
  end
end